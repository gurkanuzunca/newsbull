<div class="common-buttons">
    ...
    <a class="btn twitter share-box" href="https://twitter.com/share?url=<?php echo current_url() ?>&text=<?php echo htmlspecialchars($record->title) ?>" title="<?php echo lang('Twitter\'da Paylaş') ?>"><i class="fa fa-twitter"></i> <?php echo lang('Twitter\'da Paylaş') ?></a>
